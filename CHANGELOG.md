...
* Added support for Laravel 13 [#112](https://github.com/swisnl/json-api-client/issues/112).

## [2.6.1] - 2025-10-08

### Fixed

* Properly handle responses with an unknown size [#111](https://github.com/swisnl/json-api-client/issues/111).
